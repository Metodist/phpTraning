...
$item = get_user_by_id($_SESSION['auth']);
                    ...
                    <div class="panel-container">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="simpleinput" name="first_name" class="form-control" value="<?php echo $item[0]['first_name']; ?>">
                            </div>

                            <!-- title -->
                            <div class="form-group">
                                <label class="form-label" for="simpleinput">Место работы</label>
                                <input type="text" id="simpleinput" name="position" class="form-control" value="<?php echo $item[0]['position']; ?>">
                            </div>

                            <!-- tel -->
                            <div class="form-group">
                                <label class="form-label" for="simpleinput">Номер телефона</label>
                                <input type="text" id="simpleinput" name="phone" class="form-control" value="<?php echo $item[0]['phone']; ?>">
                            </div>

                            <!-- address -->
                            <div class="form-group">
                                <label class="form-label" for="simpleinput">Адрес</label>
                                <input type="text" id="simpleinput" name="address" class="form-control" value="<?php echo $item[0]['address']; ?>">
                            </div>
                            <!-- user_id -->
                            <input type="hidden" id="user_id" name="user_id" value="<?php echo $item[0]['id'] ?>">
