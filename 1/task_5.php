            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                        <?php
                        $a = array(array('img/demo/authors/sunny.png', 'Sunny', 'A.', '(UI/UX Expert)', 'Lead Author', '@myplaneticket', 'myorange'),
                          array('img/demo/authors/josh.png', 'Jos', 'K.', '(ASP.NET Developer)', 'Partner &amp; Contributor', '@atlantez', 'Walapa'),
                            array('img/demo/authors/jovanni.png', 'Jovanni', 'Lo', '(PHP Developer)', 'Partner &amp; Contributor', '@lodev09', 'lodev09'),
                           array('img/demo/authors/roberto.png', ' Roberto', ' R.', '(Rails Developer)', ' Partner &amp; Contributor', '@sildur', 'sildur'));
